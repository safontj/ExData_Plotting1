plot3 <- function(datafile = "hpc.txt"){
...
# PLOT CHART
        ...
        with(hpc2, plot(Time, Sub_metering_1, type = "l", xlab ="", ylab = "Energy sub metering" ))
        with(hpc2, points(Time,Sub_metering_2, type = "l", col = "red"))
        with(hpc2, points(Time,Sub_metering_3, type = "l", col = "blue"))
